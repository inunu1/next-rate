...
/* ============================================================================
 * 団体権限チェック（2ロール構成）
 * - SaaSオーナー（systemRole="owner"）は全団体操作可能
 * - 団体オーナーは自分の団体のみ操作可能
 * ========================================================================== */
